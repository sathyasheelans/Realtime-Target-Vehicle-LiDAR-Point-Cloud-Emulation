...
echo_and_run cd "/home/santhanam.17/Carla_scripts/catkin_ws/src/geometry2/tf2_sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/santhanam.17/Carla_scripts/catkin_ws/src/geometry2/tf2_sensor_msgs/setup.py" \
     \
    build --build-base "/home/santhanam.17/Carla_scripts/catkin_ws/build/geometry2/tf2_sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \
